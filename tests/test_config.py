...
def test_run_as_user_value_from_config_file() -> None:
...
def test_ignore_commented_and_invalid_lines_in_config_file() -> None:
	# Create a temporary opsiconfd configuration file with commented and invalid lines
	config_file = Path(OPSICONFD_CONF)
...
def test_config_file_without_run_as_user_line() -> None:
